	...
	<div class="col-md-12">
		...
		<div class="panel">
			<div class="panel-heading panel-heading-blue">
				<div class="page-heading"> <i class="fa fa-wrench"></i> Setting</div>
			</div> <!-- /panel-heading -->
					...
					<fieldset>
					  ...
					  <div class="form-group row text-center">
					    <div class="col-sm-offset-2 col-sm-10">
					      ...
					      <button type="submit" class="btn btn-success" data-loading-text="Loading..." id="changeUsernameBtn"> <i class="fa fa-check-circle"></i> Save Changes </button>
					    </div>
					  </div>
					</fieldset>
				</form>
